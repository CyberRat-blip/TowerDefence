    ...
    public class UIHUD : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < rscList.Count; i++)
            {
                ...
                else rscObjList.Add(rscObjList[0].Clone("RscObj" + i, new Vector3(i * 74, 0, 0)));
        ...
        void FixedUpdate()
        {
            ...
            else if (txtTimer.text != "")
            {
                txtTimer.text = "";
            }

            // Disable the TextMeshPro object if txtTimer is empty
            txtTimer.gameObject.SetActive(!string.IsNullOrEmpty(txtTimer.text));
        }
